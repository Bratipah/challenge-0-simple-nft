              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="max-w-3xl">
                  <p className="text-center text-lg mt-8">
                    🎫 Create a simple NFT to learn basics of 🏗️ Scaffold-ETH 2. You will use 👷‍♀️
                    <a
                    ...
                    to compile and deploy smart contracts. Then, you will use a template React app full of important
                    Ethereum components and hooks. Finally, you will deploy an NFT to a public network to share with
                    friends! 🚀
                  </p>
